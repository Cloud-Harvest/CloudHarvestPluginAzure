# CloudHarvestPluginAzure
This repository contains the Azure plugin for the CloudHarvest API. This plugin is responsible for interfacing with the Azure API and providing data to the CloudHarvest API.
